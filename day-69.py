# -*- coding: utf-8 -*-
"""
Created on Fri Jul 23 06:28:23 2021
...
def create_app_ui():
    ...
    [
    html.H1(id='Main_title',className="text-center", children = "Sentiment Analysis with Insights",style = {'font-size':'2.4em','font-weight':'bold','font-family':'Roboto Black Italic'}),
    ...
    dbc.Button(
        ...
        color="primary",
        className="text-center",
        style= {'width':'50%','margin-left':'420px','margin-top':'20px'}
        ),
    
    html.H1(children = None, id='result',className="text-center",style= {'padding-top':'5%'})
