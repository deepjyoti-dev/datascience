# -*- coding: utf-8 -*-
"""
Created on Sat Jul 24 15:45:46 2021
    ...
    main_layout = dbc.Container(
        dbc.Jumbotron(
                [
                    ...
                    dbc.Textarea(id = 'textarea', className="mb-3 text-center", placeholder="Enter the Review", value = 'My daughter loves these shoes', style = {'height': '150px','color':'black','background-color':'grey'}),
                    dbc.Container([
                        dcc.Dropdown(
                    id='dropdown',
