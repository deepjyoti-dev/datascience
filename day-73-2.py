# -*- coding: utf-8 -*-
"""
Created on Sat Jul 24 15:46:23 2021
...
def create_app_ui():
    ...
    [
    html.H1(id='Main_title', children = "Sentiment Analysis with Insights",style = {'text-align':'center','font-size':'2.4em','font-weight':'bold','font-family':'Roboto Black Italic'}),
    html.Hr(style={'background-color':'black'}),
    html.H2(children = "Pie Chart",style = {'text-align':'center','text-decoration':'underline'}),
    html.P([html.Img(src=app.get_asset_url('sentiment.png'),style={'width':'400px','height':'200px'})],style={'text-align':'center','border':'2px solid green'}),
    html.Hr(style={'background-color':'black'}),
    html.H2(children = "WordCloud",style = {'text-align':'center','text-decoration':'underline'}),
    html.P([html.Img(src=app.get_asset_url('wordCloud.png'),style={'width':'400px','height':'200px'})],style={'text-align':'center'}),
    html.Hr(style={'background-color':'black'}),
    html.H2(children = "Select a Review",style = {'text-align':'center','text-decoration':'underline'}),
    dcc.Dropdown(
                id='Chart_Dropdown', 
                  options=chart_dropdown_values,
                  placeholder = 'Select a Review',style={'font-size':'20px','height':'70px','padding-bottom':'20px'}
                    ),
    html.H1(children = 'Missing',id='sentiment1',style={'text-align':'center','color':'blue'}),
    html.Hr(style={'background-color':'black'}),
    html.H2(children = "Find Sentiment of Your Review",style = {'text-align':'center','text-decoration':'underline','font-style':'italic'}),
    dcc.Textarea(
        id = 'textarea_review',
        placeholder = 'Enter the review here.....',
        style = {'width':'40%', 'height':150,'font-size':'22px','margin-left':'460px','text-align':'center'}
        ),
    ...
    dbc.Button(
        ...
        id = 'button_review',
        color = 'dark',
        style= {'width':'20%','margin-top':'20px','margin-left':'600px'}
        ),
